    ...
    <div className={styles.rootCont} id="contact">
      ...
      <Form onSubmit={handleOnSubmit}>
        ...
        <div className={styles.iconsCont}>
          <a href="mailto:rohitbhaud16@gmail.com">
            <AiOutlineMail className={styles.emailicon} />
          </a>
          <a
            href="https://www.linkedin.com/in/rohit-bhaud/"
            target="_blank"
            rel="noreferrer"
          >
            <AiFillLinkedin className={styles.linkedInIcon} />
          </a>
          <a href="https://github.com/RohitBhaud" rel="noreferrer" target="_blank">
            <AiOutlineGithub className={styles.gitIcon} />
          </a>
        </div>
        <p className={styles.text}>Phone: 8356005188</p>{" "}
        <p className={styles.text}>Email: rohitbhaud16@gmail.com</p>
      </Fade>
    </div>
  )
}
